...
import{connect} from 'react-redux'
 ...
 class Itemeventhome extends Component {
    state={ }
    partcipatefunction=()=>{
     this.props.participateredoucer({...this.state.cin, participer:'true'})
 }
    render() {
...
export default connect(null,mapDispatchToprops)(Itemeventhome)